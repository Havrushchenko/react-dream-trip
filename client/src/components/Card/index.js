    ...
    <div className="flex justify-center">
      <div className="result-card-wrapper w-2/4 bg-white flex flex-col rounded-[10px] overflow-hidden shadow-lg mb-[50px]">
        <div className="flex flex-row items-baseline flex-nowrap bg-grey p-2">
          ...
          <h1 className="ml-2 uppercase font-bold text-slate-600">
            Departure{" "}
          </h1>
          <p className="departure-date ml-2 font-normal text-slate-600">
        ...
        <div className="mt-2 flex sm:flex-row mx-6 sm:justify-between flex-wrap ">
          <div className="flex flex-row place-items-center p-2">
            <div className="flex flex-col ml-2">
              ...
              <p className="flight-number text-xs text-slate-600">
                {props.flight_number}
              </p>
            </div>
          </div>
